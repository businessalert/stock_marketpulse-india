...
st.markdown(
    "100% Zero-Miss Coverage (All 5,400+ Stocks Ingested) ➔ Zerodha-Style"
    " Wilder's RSI & ROC ➔ Actionable Funnel Shortlist"
)
...
# Exact Wilder's RSI Formula (Matches Zerodha / TradingView charting standards)
...
def load_and_process_master_universe():
  ...
  # Check if RSI/ROC columns already exist in repository source; otherwise compute/map defaults safely
